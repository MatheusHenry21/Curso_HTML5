...
- Aprender e reforçar os fundamentos do HTML5
- Entender a estrutura semântica de páginas web
- Praticar a criação de formulários e elementos comuns em aplicações web
- Preparar conhecimento para integração com Django Templates
- Desenvolver disciplina de versionamento e documentação com GitHub
